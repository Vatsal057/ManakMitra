...
> **⚠ Superseded counts, authoritative reasoning.** This report documents the
> batch 01/02 audit that produced the **15 primary standards / 53 mappings**
> revision. The mapping was later expanded in two rounds to **45 primaries / 142
> mappings**; see
> [`task2_allied_standards_expansion_batch_03.md`](task2_allied_standards_expansion_batch_03.md)
> for the current state. The counts here, and the "remaining 39 flagship
> products" note in section 6, are therefore out of date.
>
> What still holds: everything promoted here survives in the current file, and
> the nine rejected pairings in section 3 remain purged — both enforced by
...
> reasoning below remains the authoritative record of *why* individual mappings
